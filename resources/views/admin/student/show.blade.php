                ...
                <div class="sm:flex flex-row justify-between">
                    ...
                    <div class="flex flex-col gap-y-6">
                        ...
                        <div>
                            ...
                            @if ($subscribeTransaction->is_paid)
                            <h3 class="text-green-500 font-bold">{{ \Carbon\Carbon::parse($subscribeTransaction->subscribe_transactions)->format('d M Y - G:i') }}</h3>
                            @else
                        ...
                        <div>
                            ...
                            @if ($subscribeTransaction->is_paid)
                            <h3 class="text-red-600 font-bold">{{ \Carbon\Carbon::parse($subscribeTransaction->subscribe_transactions)->addMonth(1)->format('d M Y - G:i') }}</h3>
                            @else
                            <h3 class="text-red-500 font-bold">Not started yet</h3>
                            @endif
                        </div>
