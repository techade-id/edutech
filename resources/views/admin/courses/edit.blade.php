            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.courses.update', $course) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <img src="{{ Storage::url($course->thumbnail) }}" alt="" class="rounded-sm object-cover mt-1 mb-4 w-96">
                        <x-text-input id="thumbnail" class="block mt-1 w-full file:text-white file:py-2 file:px-4 file:rounded-md file:bg-lime-600 file:hover:bg-lime-500 file:cursor-pointer file:border-transparent" type="file" name="thumbnail" autofocus autocomplete="thumbnail" />
