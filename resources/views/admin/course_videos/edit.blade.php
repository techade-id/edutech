            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <div class="item-card flex flex-row gap-y-10 justify-between items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        <img src="{{ Storage::url($courseVideo->course->thumbnail) }}" alt="" class="rounded-2xl object-cover w-[120px] sm:w-[180px]">
                    ...
                    <div>
                        ...
                        <h3 class="text-indigo-950 md:text-xl font-bold">{{ $courseVideo->course->teacher->user->name }}</h3>
                    </div>
                </div>
