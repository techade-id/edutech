    ...
    <x-slot name="header">
        <div class="flex flex-row justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ Auth::user()->hasRole('owner') ? 'Owner Dashboard' : __('Dashboard') }}
            </h2>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                @role('owner')
                <a href="{{ route('front.index') }}" class="bg-indigo-500 hover:bg-indigo-700 py-2 px-4 rounded-full w-fit text-white">Go to Platform</a>
                <div class="item-card flex flex-col gap-y-10 sm:flex-row justify-between items-center">
                ...
                <div class="item-card flex flex-col gap-y-10 md:flex-row justify-between items-center">
                    ...
                    <a href="{{route('admin.courses.create')}}" class="w-fit font-bold py-2 px-4 bg-indigo-700 text-white rounded-full">
                        Create New Course
                    </a>
                </div>
                @endrole
                ...
                <!-- Students Role -->
                @role('student')
                <h3 class="text-indigo-950 font-bold text-2xl">Welcome to Techade Edutech</h3>
                <hr>
                <h3 class="text-indigo-950 font-bold text-lg">Upgrade Your Skills Today</h3>
                <p class="text-slate-500 text-base">
                    Grow your career with experienced teachers in Techade Edutech.
                </p>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <p>Need Help?</p>
                    <a href="https://wa.me/6287812066967" class="w-fit font-bold py-2 px-4 bg-green-600 text-white rounded-full">
                        Contact Us
                    </a>
                    @endrole
                </div>
